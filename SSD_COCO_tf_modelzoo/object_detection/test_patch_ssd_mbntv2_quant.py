...
def load_model():
    ...
    model_dir = 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/models_proto_converted/ssd_mobilenet_v2_coco_quantized/saved_model/'
...
# In[ ]:
savedir = 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/test_images/ssd_mobilenet_v2_coco_quantized/'
...
txtpath_c = "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/test_images/ssd_mobilenet_v2_coco_quantized/clean/ssdmnv2_q-labels/"
...
for image_path in TEST_IMAGE_PATHS:
    ...
    if image_path_str.endswith('.jpg') or image_path_str.endswith('.png'):
        ...
        txtpath_p = os.path.join(savedir, 'proper_patched_random/', 'ssdmnv2_q-labels/', txtname)
...
with open('C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv2_coco_quantized/patch_results_random.json', 'w') as fp:
