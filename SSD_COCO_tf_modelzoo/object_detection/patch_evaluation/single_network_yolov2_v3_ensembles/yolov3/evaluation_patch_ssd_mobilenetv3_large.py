...
patch_results_obj = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv3_large/yolov3_patches/patch_results_obj.json", class_label_map={0: 'person'})
...
plt.savefig('C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/single_patches_vs_single_networks/ssd_mobilenetv3_large/yolov3_patch/pr_curve_ssdmbnv3large_ref_real_inria.eps')
plt.savefig('C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/single_patches_vs_single_networks/ssd_mobilenetv3_large/yolov3_patch/pr_curve_ssdmbnv3large_ref_real_inria.png')
#plt.show()
