...
patch_results_obj = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v1_coco_2017_11_17/yolov3_patches/patch_results_obj.json", class_label_map={0: 'person'})
#patch_results_cls = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v1_coco_2017_11_17/yolov3_patches/patch_results_cls.json', class_label_map={0: 'person'})
patch_results_cls_obj = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v1_coco_2017_11_17/yolov3_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
...
plt.gcf().suptitle('SSD_MobileNetV1, dataset = INRIA, PATCH:yolov3')
plt.gca().set_ylabel('Precision')
plt.gca().set_xlabel('Recall')
plt.gca().set_xlim([0, 1.05])
plt.gca().set_ylim([0, 1.05])
plt.gca().legend(loc=4)
plt.savefig('C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/single_patches_vs_single_networks/ssd_mobilenet_v1_coco_2017_11_17/yolov3_patch/pr_curve_ssdmbnv1_ref_real_inria.eps')
plt.savefig('C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/single_patches_vs_single_networks/ssd_mobilenet_v1_coco_2017_11_17/yolov3_patch/pr_curve_ssdmbnv1_ref_real_inria.png')
#plt.show()
