...
#annotations = bb.io.load('anno_darknet', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/test_images/ssd_mobilenet_v2_coco_2018_03_29/clean/ssdmnv2-labels/', class_label_map={0: 'person'})
...
patch_results_obj = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v2_coco_2018_03_29/ensemble_yv3_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj.json", class_label_map={0: 'person'})
patch_results_obj_cls_mean = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v2_coco_2018_03_29/ensemble_yv3_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls_mean.json', class_label_map={0: 'person'})
patch_results_cls_obj = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v2_coco_2018_03_29/ensemble_yv3_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
#patch_results_obj_paper = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v2_coco_2018_03_29/yolov3_patches/patch_results_obj_paper.json', class_label_map={0: 'person'})
...
plt.gcf().suptitle('SSD_MobileNetV2, dataset = INRIA, PATCH:yv3+mbntv1+mbntv2')
plt.gca().set_ylabel('Precision')
plt.gca().set_xlabel('Recall')
plt.gca().set_xlim([0, 1.05])
plt.gca().set_ylim([0, 1.05])
plt.gca().legend(loc=4)
plt.savefig('C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/single_patches_vs_single_networks/ssd_mobilenet_v2_coco_2018_03_29/ensemble2_yv3_mbnt12/pr_curve_ssdmbnv2_ref_real_inria.eps')
plt.savefig('C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/single_patches_vs_single_networks/ssd_mobilenet_v2_coco_2018_03_29/ensemble2_yv3_mbnt12/pr_curve_ssdmbnv2_ref_real_inria.png')
#plt.show()
