...
patch_results_obj = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssdlite_mobilenet_v2_coco_2018_05_09/yolov2_patches/patch_results_obj_ale.json', class_label_map={0: 'person'})
patch_results_cls = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssdlite_mobilenet_v2_coco_2018_05_09/yolov2_patches/patch_results_cls_ale.json', class_label_map={0: 'person'})
patch_results_cls_obj = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssdlite_mobilenet_v2_coco_2018_05_09/yolov2_patches/patch_results_obj_cls_ale.json', class_label_map={0: 'person'})
patch_results_obj_paper = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssdlite_mobilenet_v2_coco_2018_05_09/yolov2_patches/patch_results_obj_paper.json', class_label_map={0: 'person'})
...
plt.gcf().suptitle('SSDLite_MobileNetV2, dataset = INRIA, PATCH:yolov2')
plt.gca().set_ylabel('Precision')
plt.gca().set_xlabel('Recall')
plt.gca().set_xlim([0, 1.05])
plt.gca().set_ylim([0, 1.05])
plt.gca().legend(loc=4)
plt.savefig('C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/single_patches_vs_single_networks/ssdlite_mobilenet_v2_coco_2018_05_09/yolov2_patch/pr_curve_ssdlitembnv2_ref_real_inria.eps')
plt.savefig('C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/single_patches_vs_single_networks/ssdlite_mobilenet_v2_coco_2018_05_09/yolov2_patch/pr_curve_ssdlitembnv2_ref_real_inria.png')
#plt.show()
