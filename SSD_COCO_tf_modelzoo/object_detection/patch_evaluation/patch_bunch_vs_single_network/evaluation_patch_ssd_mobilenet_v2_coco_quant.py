...
clean_results = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv2_coco_quantized/clean_results.json", class_label_map={0: 'person'})
patch_yolov2_best = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv2_coco_quantized/yolov2_patches/patch_results_obj.json", class_label_map={0: 'person'})
patch_yolov3_best = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv2_coco_quantized/yolov3_patches/patch_results_obj.json", class_label_map={0: 'person'})
patch_yolov4_best = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv2_coco_quantized/yolov4_patches/patch_results_obj.json", class_label_map={0: 'person'})

patch_ssd_mbntv1 = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv2_coco_quantized/ssd_mbntv1_patches/patch_results_obj_cls.json", class_label_map={0: 'person'})
patch_ssdlite_mbntv2 = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv2_coco_quantized/ssdlite_mbntv2_patches/patch_results_obj_cls.json", class_label_map={0: 'person'})
patch_ensemble_yv2_ssd_mbntv1_ssdlitembntv2_best = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv2_coco_quantized/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json", class_label_map={0: 'person'})
patch_ensemble_yv3_ssd_mbntv1_ssdlitembntv2_best = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv2_coco_quantized/ensemble_yv3_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json", class_label_map={0: 'person'})
...
plt.gcf().suptitle('SSD_MobileNetV2_q, dataset = INRIA, all_patches')
plt.gca().set_ylabel('Precision')
plt.gca().set_xlabel('Recall')
plt.gca().set_xlim([0, 1.05])
plt.gca().set_ylim([0, 1.05])
plt.gca().legend(loc=4)
plt.savefig("C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/patch_bunch_vs_single_network/ssd_mobilenet_v2_coco_quant/ssd_mbntv2_q_all_patches.png")
plt.savefig("C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/patch_bunch_vs_single_network/ssd_mobilenet_v2_coco_quant/ssd_mbntv2_q_all_patches.eps")
#plt.show()
