...
patch_yolov2_best = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v1_coco_2017_11_17/yolov2_patches/patch_results_obj_ale.json", class_label_map={0: 'person'})
patch_yolov3_best = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v1_coco_2017_11_17/yolov3_patches/patch_results_obj.json", class_label_map={0: 'person'})
patch_yolov4_best = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v1_coco_2017_11_17/yolov4_patches/patch_results_obj.json", class_label_map={0: 'person'})
patch_ssd_mbntv1 = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v1_coco_2017_11_17/ssd_mbntv1_patches/patch_results_obj_cls_ale.json", class_label_map={0: 'person'})
patch_ssdlite_mbntv2 = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v1_coco_2017_11_17/ssdlite_mbntv2_patches/patch_results_obj_cls_ale.json", class_label_map={0: 'person'})
# patch_ensemble_yv2_ssd_mbntv1_ssdlitembntv2_best = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v1_coco_2017_11_17/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json", class_label_map={0: 'person'})
# patch_ensemble_yv3_ssd_mbntv1_ssdlitembntv2_best = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v1_coco_2017_11_17/ensemble_yv3_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json", class_label_map={0: 'person'})
# patch_ensemble_yv2_yv3_ssdlitembntv2_best = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v1_coco_2017_11_17/ensemble_yv2_yv3_ssdlitembntv2_patches/patch_results_obj_cls.json", class_label_map={0: 'person'})
...
plt.gcf().suptitle('SSD_MobileNetV1, dataset = INRIA, all_patches')
plt.gca().set_ylabel('Precision')
plt.gca().set_xlabel('Recall')
plt.gca().set_xlim([0, 1.05])
plt.gca().set_ylim([0, 1.05])
plt.gca().legend(loc=4)
plt.savefig("C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/patch_bunch_vs_single_network/ssd_mobilenet_v1_coco_2017_11_17/ssd_mbntv1_all_patches.png")
plt.savefig("C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/patch_bunch_vs_single_network/ssd_mobilenet_v1_coco_2017_11_17/ssd_mbntv1_all_patches.eps")
#plt.show()
