...
patch_results_obj_ale_yolov2 = bb.io.load('det_coco', 'C:/Users/Alessandro/Desktop/GitLab/YOLOv2_d2k_adv_COCO_thys2019/json_files/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_obj_cls_results.json', class_label_map={0: 'person'})
patch_results_obj_ale_yolov3 = bb.io.load('det_coco', 'C:/Users/Alessandro/Desktop/GitLab/YOLOv3_d2k_adv_COCO_thys2019/json_files/yolov3/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
patch_results_obj_ale_yolov3_tiny = bb.io.load('det_coco', 'C:/Users/Alessandro/Desktop/GitLab/YOLOv3_d2k_adv_COCO_thys2019/json_files/yolov3_tiny/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})

patch_results_obj_ale_ssdmbntv1 = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v1_coco_2017_11_17/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
patch_results_obj_ale_ssdmbntv2 = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenet_v2_coco_2018_03_29/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
patch_results_obj_ale_ssdmbntv1_q = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv1_coco_quantized/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
patch_results_obj_ale_ssdmbntv2_q = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv2_coco_quantized/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})

patch_results_obj_ale_ssdlitembntv2 = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssdlite_mobilenet_v2_coco_2018_05_09/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
patch_results_obj_ale_ssdmbntv3small = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv3_small/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})
patch_results_obj_ale_ssdmbntv3large = bb.io.load('det_coco', 'C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/json_files/ssd_mobilenetv3_large/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json', class_label_map={0: 'person'})

patch_results_obj_ale_ssdlitembntv2_voc = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/ssd_models_pytorch_haoi/json_files/ssdlitembntv2/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json", class_label_map={0: 'person'})
patch_results_obj_ale_ssdmbntv1_voc = bb.io.load('det_coco', "C:/Users/Alessandro/PycharmProjects/ssd_models_pytorch_haoi/json_files/ssdmbntv1/ensemble_yv2_ssdmbntv1_ssdlitembntv2_patches/patch_results_obj_cls.json", class_label_map={0: 'person'})
...
obj_ale_ssdlite_mbntv2_voc = bb.stat.pr(patch_results_obj_ale_ssdlitembntv2_voc, annotations, threshold=0.5)
...
ap = bb.stat.ap(obj_ale_ssdlite_mbntv2_voc)
plt.plot(obj_ale_ssdlite_mbntv2_voc['recall'], obj_ale_ssdlite_mbntv2_voc['precision'], label=f'SSDLITE_MNV2_VOC: AP: {round(ap*100, 2)}%')
...
plt.gcf().suptitle('PATCH:ENSEMBLE1, dataset = INRIA')
plt.gca().set_ylabel('Precision')
plt.gca().set_xlabel('Recall')
plt.gca().set_xlim([0, 1.05])
plt.gca().set_ylim([0, 1.05])
plt.gca().legend(loc=4)
plt.savefig('C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/networks_bunch_vs_single_patch/ensemble1_yv2/pr_curve_ensemble1_patch_inria.eps')
plt.savefig('C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/networks_bunch_vs_single_patch/ensemble1_yv2/pr_curve_ensemble1_patch_inria.png')
