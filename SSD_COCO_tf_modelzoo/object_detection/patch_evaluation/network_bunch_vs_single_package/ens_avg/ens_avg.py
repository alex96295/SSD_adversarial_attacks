...
patch_results_obj_ale_yolov2 = bb.io.load('det_coco', "C:/Users/Alessandro/Desktop/GitLab/yolov2_pytorch/json_files/ens_avg.json", class_label_map={0: 'person'})
patch_results_obj_ale_yolov3 = bb.io.load('det_coco', "C:/Users/Alessandro/Desktop/GitLab/yolov3_pytorch/json_files/ens_avg.json", class_label_map={0: 'person'})
patch_results_obj_ale_yolov4 = bb.io.load('det_coco', "C:/Users/Alessandro/Desktop/GitLab/YOLOv4_d2p_adv_COCO/json_files/ens_avg.json", class_label_map={0: 'person'})
...
plt.gcf().suptitle('PATCH:YV2+YV3+YV4 AVERAGE STRATEGY, dataset = INRIA')
plt.gca().set_ylabel('Precision')
plt.gca().set_xlabel('Recall')
plt.gca().set_xlim([0, 1.05])
plt.gca().set_ylim([0, 1.05])
plt.gca().legend(loc=4)
plt.savefig("C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/networks_bunch_vs_single_patch/ens_avg/pr_curve_ensemble_avg.eps", dpi=500)
plt.savefig("C:/Users/Alessandro/PycharmProjects/tf_model_garden/research/object_detection/pr_curves/networks_bunch_vs_single_patch/ens_avg/pr_curve_ensemble_avg.png", dpi=500)
